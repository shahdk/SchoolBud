...
public class SchedulerTester {
	...
	public void testScheduleFourClassesWithVaryingSectionsWithOverlapSameDayWithMultiHour() {
		...
		assertEquals(SchedulerTester.createIntegerList(1, 3, 7, 9, 1, 3, 8, 9,
				1, 4, 7, 9, 2, 3, 7, 9, 2, 4, 7, 9, 2, 4, 8, 9),
	...
	public void testScheduleFourClassesWithVaryingSectionsWithOverlapDifferentDaysWithMultiHour() {
		...
		scheduler.permutateSchedules();
		// test small gap but ignore all days except Friday = 3 results
		assertEquals(
				4,
				scheduler.filterHoursConcentration(4, 4,
						SchedulerTester.createIntegerList(0, 1, 2, 3, 5, 6))
						.size());
		scheduler.permutateSchedules();

		// test two previous filters in combination
		scheduler.filterHoursConcentration(2, 8, null);
		assertEquals(
				1,
				scheduler.filterHoursConcentration(4, 4,
						SchedulerTester.createIntegerList(0, 1, 2, 3, 5, 6))
