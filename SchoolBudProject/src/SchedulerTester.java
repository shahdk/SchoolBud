...
//		scheduler.permutateSchedules();
//
//		// test with 2 max / 1 min (strict) - exact occurrences - no exception = 0
//		assertEquals(0, (Scheduler.getDayHoursLists(scheduler.filterGaps(2, 1,
//				1, 1, 0, true, null)).size()));
//		scheduler.permutateSchedules();
//
//		// test with 2 max / 1 min (strict) - exact occurrences - BUT 1 exception = 2
//		assertEquals(SchedulerTester.createIntegerList(1, 4, 7, 9, 2, 4, 7, 9),
//				(Scheduler.getDayHoursLists(scheduler.filterGaps(2, 1, 1, 1, 1,
//						true, null))));
//		scheduler.permutateSchedules();
//
...
//		assertEquals(0, scheduler.filterGaps(0, 5, 0, 5, 1, false, null).size());
//		scheduler.permutateSchedules();
//
//		// skipping All should return all schedules with ZERO GAPS
//		assertEquals(
//				8,
//				scheduler.filterGaps(0, 5, 0, 5, 1, false,
