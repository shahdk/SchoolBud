...
public class SchedulerTester {
	 ...
	 assertNotNull(sched.filterGaps(2, 2, 2, 2, 0, true, null));
	 }
	 ...
	 assertEquals(new ArrayList<ArrayList<ArrayList<SchedulerCourse>>>(),
	 scheduler.filterGaps(2, 2, 2, 2, 0, true, null));
	 }
	 ...
	 // test filters
	 assertEquals(0, scheduler.filterGaps(2, 2, 2, 2, 0, true, null).size());
	 }
	 ...
	 // one class
	 assertEquals(1, scheduler.filterGaps(2, 2, 2, 2, 0, true, null).size());
	 }
	 ...
	 assertEquals(1, scheduler.filterGaps(2, 1, 0, 3, 0, true, null).size());
	 // test gaps filter - with 4 Gaps max but less allowed) --> 1 answer
	 scheduler.permutateSchedules();
	 assertEquals(1, scheduler.filterGaps(4, 1, 0, 3, 0, false, null).size());
	 // test gaps filter - with 4 Gaps Only) --> 0 answers
	 scheduler.permutateSchedules();
	 assertEquals(0, scheduler.filterGaps(4, 2, 0, 3, 0, true, null).size());
	 // test gaps filter - with 2 Gaps only, but zero occurrences) --> 0
	 // answers
	 scheduler.permutateSchedules();
	 assertEquals(0, scheduler.filterGaps(2, 0, 2, 0, 0, true, null).size());
	 ...
	 assertEquals(1, scheduler.filterGaps(1, 1, 1, 1, 0, true, null).size());
	 // test gaps filter - with 4 Gaps max but less allowed) --> 3 answer
	 scheduler.permutateSchedules();
	 assertEquals(3, scheduler.filterGaps(4, 1, 0, 3, 0, false, null).size());
	 // test gaps filter - with 3 Gaps Only) --> 1 answers
	 scheduler.permutateSchedules();
	 assertEquals(1, scheduler.filterGaps(3, 1, 3, 1, 0, true, null).size());
	 ...
	 assertEquals(0, scheduler.filterGaps(1, 1, 0, 1, 0, false, null).size());
	 // test gaps filter - SAME AS ABOVE - but filter was reset so it will
	 // produce 1 result --> 1 answers
	 scheduler.permutateSchedules();
	 assertEquals(1, scheduler.filterGaps(1, 1, 0, 1, 0, false, null).size());
	 }
	...
	public void testScheduleFourClassesWithVaryingSectionsWithOverlapSameDayWithMultiHour() {
	 ...
	 @Test
	 public void
	 testScheduleFourClassesWithVaryingSectionsWithOverlapDifferentDaysWithMultiHour()
	 {
